...
#include "FontsRus/Cooper18pt8b.h"
...
void setup() {
  ...
  tft.drawGFXText(x, y, s3, COLOR_GREEN); // Print string
   ...
   // Draw third string in same font
 tft.setGFXFont(&Cooper18pt8b);  // Change font
  String s4 = "Привет!"; // Create string object
  y += h + 5; // Set y position to previous string height plus shift down 2 pixels
  tft.drawGFXText(x, y, s3, COLOR_GREEN); // Print string
}
